...
// data path relative to the exetutable file.
string groundtruth_file = "../../data/ch4/groundtruth.txt";
string estimated_file = "../../data/ch4/estimated.txt";
...
int main(int argc, char **argv) {
  ...
  cout << "sophus good!" << endl;
  cout << "sophus good again!" << endl;
